...
def commands():
    ...
    parser.add_argument("-d", nargs="+", dest="delete", type=int, metavar=("all", "ID"), help="delete artist ids")
    parser.add_argument("-c", nargs="+", dest="clear", type=int, metavar=("all", "ID"), help="clear artists update info")
